...
exports.onFinalize = functions.storage.object().onFinalize(async (object) => {
  ...
  await spawn('convert', [localFilePath, '-resize', '800x800>', '-auto-orient', '-gravity', 'center', '-pointsize', '130', '-fill', 'rgba(240, 237, 234, 0.35)', '-draw', 'text 0,-100 "jojo_studio"', localFilePath]);
